...
ProgressDialog progressDialog;
        ...
        if (mGoogleApiClient.isConnected()) {
            ...
            while (iterator.hasNext()) {
                ...
                resultList.add(new PlaceAutocomplete(prediction.getPlaceId(),
                        prediction.getFullText(null),prediction.getPrimaryText(null),prediction.getSecondaryText(null)));
            }
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence description,CharSequence area,CharSequence city) {
